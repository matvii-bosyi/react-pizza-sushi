...
import { useBasketGetAllQuery, useBasketMutation, useClearBasketMutation } from '@/api/basket'
...
const ProductCard = ({ product }: ProductCardProps) => {
	...
	return (
		<>
			...
			/>
			<div className='bg-white rounded-[36px] p-[20px] w-[650px] h-[335px] flex flex-row gap-[20px]'>
